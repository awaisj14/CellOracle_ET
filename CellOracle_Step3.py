...
links = co.load_hdf5("links_predicted_v2.celloracle.links")
links
...
plt.show()
fig.savefig('Zbtb16_Meis2_Nfia_KO.pdf', dpi=600, bbox_inches='tight')
...
plt.show()
fig.savefig('Nfia_KO.pdf', dpi=600, bbox_inches='tight')
...
plt.show()
fig.savefig('Meis2_KO.pdf', dpi=600, bbox_inches='tight')
...
plt.show()
fig.savefig('Zbtb16_KO.pdf', dpi=600, bbox_inches='tight')
...
plt.show()
fig.savefig('Meis2_Zbtb16_KO.pdf', dpi=600, bbox_inches='tight')
...
plt.show()
fig.savefig('Meis2_Nfia_KO.pdf', dpi=600, bbox_inches='tight')
...
plt.show()
fig.savefig('Zbtb16_Nfia_KO.pdf', dpi=600, bbox_inches='tight')
