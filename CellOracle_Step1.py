...
adata.obs['new_clusters'] = adata.obs['predicted.id'].copy()
# Merge 'distal' and 'intermediate' into 'merged_cluster'
adata.obs['new_clusters'] = adata.obs['new_clusters'].replace({'L5 PT ALM Hpgd': 'proximal', 'L5 PT ALM Npsr1': 'proximal','L5 PT ALM Slco2a1': 'distal'})
adata.obs['Age_predicted'] = adata.obs.apply(lambda x: f"{x['Age']}_{x['new_clusters']}", axis=1)
...
sc.pl.umap(adata, color="Age_predicted")
...
adata.write_h5ad("Phil_only_CO_v5.h5ad")
adata = sc.read_h5ad("Phil_only_CO_v5.h5ad")
...
clusters_in_distal_lineage = ['P04_distal','P08_distal','P12_distal','P21_distal']
clusters_in_proximal_lineage = ['P04_proximal','P08_proximal','P12_proximal','P21_proximal']

# Make a dictionary
lineage_dictionary = {"distal": clusters_in_distal_lineage,"proximal": clusters_in_proximal_lineage}
...
root_cells = {"proximal": "P.MO4.12_CTGATCCGTCAAAGCG-1","distal": "L5ET_4812_ATCGATGGTCCAAAGG-1"}
...
adata.write_h5ad("Final_celloracle_predicted_V2.h5ad")
