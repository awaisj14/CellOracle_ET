...
adata = sc.read_h5ad("Final_celloracle_predicted_v2.h5ad")
...
TFsmerge.to_csv('Final_tfs_links_v2.csv')
...
# Save oracle object.
oracle.to_hdf5("Paul_15_data_predicted_v2.celloracle.oracle")
# Load file.
oracle = co.load_hdf5("Paul_15_data_predicted_v2.celloracle.oracle")
...
# Save Links object.
links.to_hdf5(file_path="links_predicted_v2.celloracle.links")
...
links = co.load_hdf5(file_path="links_predicted_v2.celloracle.links")
...
cluster_name = "P04_distal"
filtered_links_df = links.filtered_links[cluster_name]
filtered_links_df.head()
filtered_links_df.to_csv("/Users/javed/Documents/Philipp/Index_regression_GRN_predicted/P04_distal.csv")

cluster_name = "P08_distal"
filtered_links_df = links.filtered_links[cluster_name]
filtered_links_df.head()
filtered_links_df.to_csv("/Users/javed/Documents/Philipp/Index_regression_GRN_predicted/P08_distal.csv")

cluster_name = "P12_distal"
filtered_links_df = links.filtered_links[cluster_name]
filtered_links_df.head()
filtered_links_df.to_csv("/Users/javed/Documents/Philipp/Index_regression_GRN_predicted/P12_distal.csv")

cluster_name = "P21_distal"
filtered_links_df = links.filtered_links[cluster_name]
filtered_links_df.head()
filtered_links_df.to_csv("/Users/javed/Documents/Philipp/Index_regression_GRN_predicted/P21_distal.csv")




cluster_name = "P04_proximal"
filtered_links_df = links.filtered_links[cluster_name]
filtered_links_df.head()
filtered_links_df.to_csv("/Users/javed/Documents/Philipp/Index_regression_GRN_predicted/P04_proximal.csv")
    
cluster_name = "P08_proximal"
filtered_links_df = links.filtered_links[cluster_name]
filtered_links_df.head()
filtered_links_df.to_csv("/Users/javed/Documents/Philipp/Index_regression_GRN_predicted/P08_proximal.csv")

cluster_name = "P12_proximal"
filtered_links_df = links.filtered_links[cluster_name]
filtered_links_df.head()
filtered_links_df.to_csv("/Users/javed/Documents/Philipp/Index_regression_GRN_predicted/P12_proximal.csv")

cluster_name = "P21_proximal"
filtered_links_df = links.filtered_links[cluster_name]
filtered_links_df.head()
filtered_links_df.to_csv("/Users/javed/Documents/Philipp/Index_regression_GRN_predicted/P21_proximal.csv")
